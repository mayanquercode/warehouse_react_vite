...
import { supabase } from '../libs/supabase'; // Cambiado de 'react-router' a 'react-router-dom'
...
function Login() {
    ...
    const onSubmitForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (data?.user) {
            ...
            // Lógica de redirección basada en el rol que inyectamos vía SQL
            if (role === 'admin') {
                navigate('/login', { replace: true });
            } else {
                // Si tienes otra ruta para vendedores, cámbiala aquí
